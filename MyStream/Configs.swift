...
let PARSE_APP_ID = "LShV0Q5wA4FwXCjTmblIXRLuOkc52NR6aEbhzpyU"
let PARSE_CLIENT_KEY = "6Usbm2XCVaBQQTR0xDuies5HBhUS7F9G3iayPAdO"
//-----------------------------------------------------------------------------
...
let FACEBOOK_URL = "https://www.facebook.com/cubycode"
let TWITTER_URL = "https://twitter.com/cubycode"


// REPLACE "1253850533" WITH THE APP ID OF YOUR APP ON THE APP STORE
let APP_ID = "1253850533"
...
let MAIN_COLOR = UIColor(red: 133/255, green: 96/255, blue: 168/255, alpha: 1.0)
...
extension UIViewController {
    func sendPushNotification(currentUser:PFUser, pushMess:String, textColumn:String, obj:PFObject, userPointerColumn:String) {
        ...
        userPointer.fetchIfNeededInBackground(block: { (user, error) in
            if error == nil {
                print(currentUser[USER_FULLNAME])
                print(pushMess)
                print(obj[textColumn])
